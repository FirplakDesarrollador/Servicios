...
export default function ServiciosAbiertosClientePage() {
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                             <div className="flex flex-col items-end">
                                <span className="text-[8px] font-black text-slate-300 uppercase leading-none mb-1">Estado Solicitud</span>
                        ...
                        {products.map((p: any, idx: number) => (
                            <div key={idx} className="flex items-center justify-between text-[11px] bg-white p-2 rounded-xl border border-slate-100 shadow-sm">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="bg-brand/10 text-brand px-2 py-0.5 rounded-md font-black">{p.cantidad}</span>
                                </div>
                            </div>
                        ))}
                    </div>
