      ...
      <main className="pt-24 pb-10 px-4 sm:px-8 w-full max-w-[96%] xl:max-w-[1800px] mx-auto flex flex-col items-stretch">
        ...
        >
          ...
          <div className="relative group mb-2.5">
            ...
            <div className="absolute -bottom-0.5 -right-0.5 w-4.5 h-4.5 bg-emerald-500 rounded-full border-2 border-white flex items-center justify-center shadow-md">
              <CheckCircle2 className="w-2.5 text-white" />
            </div>
          </div>
