...
async function run() {
  try {
    ...
    console.log('ItemCode:', sapItem.ItemCode);
    console.log('ItemName:', sapItem.ItemName);
    console.log('U_Grupo:', sapItem.U_Grupo);
    console.log('Valid:', sapItem.Valid);
    console.log('Frozen:', sapItem.Frozen);
